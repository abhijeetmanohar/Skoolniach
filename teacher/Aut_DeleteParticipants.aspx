<%@ Page Title="" Language="C#" MasterPageFile="~/teacher/TeacherMasterPage.master" AutoEventWireup="true" CodeFile="Aut_DeleteParticipants.aspx.cs" Inherits="teacher_DeleteParticipants" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table align="center" class="auto-style148">
        <tr>
            <td class="auto-style149" colspan="2"><strong>Delete Participants <span class="auto-style3">(Authorized)</span></strong></td>
        </tr>
        <tr>
