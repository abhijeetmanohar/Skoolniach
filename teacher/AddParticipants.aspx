<%@ Page Title="" Language="C#" MasterPageFile="~/teacher/TeacherMasterPage.master" AutoEventWireup="true" CodeFile="AddParticipants.aspx.cs" Inherits="teacher_AddStudentsForQuiz" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table align="center" class="auto-style2">
        <tr>
            <td class="pop_up2" colspan="2"><strong><span class="auto-style3">Add Participants</span></strong></td>
        </tr>
        <tr>
                    ...
                    <div class="body">
                        <table style="width: 100%; height: 0">
                            ...
                            <tr>
                                ...
                                <td class="auto-style1">
                                    <asp:Label ID="lblP_Type" runat="server" />
        ...
        <tr>
            <td colspan="2">
                <asp:GridView ID="GridView2" runat="server" BackColor="White" Caption='<table border="2" width="100%" cellpadding="0" cellspacing="0" bgcolor="darkblue"><tr class="auto-style11"><td>Participants added to the above Quiz Id</td></tr></table>' BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
                    <AlternatingRowStyle BackColor="#DCDCDC" />
                    <Columns>
                ...
                <br />
                <p>
                    <asp:Button ID="btnAQ" runat="server" Text="Add Participants To Authorized Quiz" OnClick="btnAQ_Click" />
                </p>
            </td>
        </tr>
    </table>
