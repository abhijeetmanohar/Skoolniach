...
public partial class teacher_AddStudentsForQuiz : System.Web.UI.Page
{
    ...
    protected void txtSearch_TextChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            GridView1.DataBind();
            c.Open();
            SqlCommand cmd = new SqlCommand("select Class,Name,House,Admission_Num,P_Type from Students where Name='" + txtSearch.Text + "'", c);
    ...
    protected void OnSelectedIndexChanged1(object sender, EventArgs e) //Mark as Absent
    {
        try
        {
            ...
            lblP_Type.Text = GridView1.SelectedRow.Cells[5].Text;
            mpe.Show();
        }
        catch (Exception ex)
        {
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            String Slash = "/";
            SqlCommand cmd1 = new SqlCommand("insert into Participants values('" + lblAdmissionNo.Text + Slash + lblQuizId.Text + "','" + lblQuizId.Text + "','" + lblAdmissionNo.Text + "','" + lblClass.Text + "','" + lblName.Text + "','" + lblHouse.Text + "','0','0','"+lblP_Type.Text+"','0')", c);
            c.Open();
    ...
    {
        Response.Redirect("~/teacher/Aut_AddParticipants.aspx");
    }
}