<%@ Page Title="Update Subject" Language="C#" MasterPageFile="~/admin/adminMasterPage.master" AutoEventWireup="true" CodeFile="UpdateSubject.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      <table style="width: 100%">
        <tr>
          ...
          <p class="top-menu" style="text-align: center"> <img src="../images/addsubject.png" /> <span style="font-size: x-large">  &nbsp;&nbsp; <strong>UPDATE SUBJECT</strong></span></p>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="Id" DataSourceID="SqlDataSource1" EmptyDataText="No records has been added." GridLines="Vertical">
                   ...
                   <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SkoolniachConnectionString %>" SelectCommand="SELECT [Id], [Subject] FROM [Subject]" UpdateCommand="UPDATE Subject SET Subject = @Subject WHERE Id = @Id">
                       <UpdateParameters>
