<%@ Page Title="Arrangement" Language="C#" MasterPageFile="~/vice/viceMasterPage.master" AutoEventWireup="true" CodeFile="Arrangement_Automatic.aspx.cs" Inherits="Arrangement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="panel1" runat="server">
        ...
        <asp:GridView ID="GridView2" Width="100%" HeaderStyle-BackColor="Black" HeaderStyle-ForeColor="White" runat="server" OnSelectedIndexChanged="OnSelectedIndexChanged2" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" OnRowDeleting="OnRowDeleting" EmptyDataText="None of the teachers are added to the Absentees List." Caption='<table border="2" width="100%" cellpadding="0" cellspacing="0" bgcolor="darkblue"><tr class="auto-style11"><td>Absentees</td></tr></table>' CaptionAlign="Top" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical">
            <AlternatingRowStyle BackColor="#DCDCDC" />
            <Columns>
                ...
                <asp:BoundField DataField="ZeroPeriod" HeaderText="0" SortExpression="ZeroPeriod" />
                ...
                <table style="width: 100%; height: 0">
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td style="width: 77px">
                            <asp:Label ID="ddlIdZPD" runat="server" Text=""></asp:Label>
                    ...
                    <tr>
                        ...
                        <td style="width: 77px">
                            <asp:Label ID="ddlIdFPD" runat="server" Text=""></asp:Label>
                    ...
                    <tr>
                        ...
                        <td style="width: 77px">
                              <asp:Label ID="ddlIdSPD" runat="server" Text=""></asp:Label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 77px">
                             <asp:Label ID="ddlIdTPD" runat="server"></asp:Label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 77px">
                            <asp:Label ID="ddlIdFOPD" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 77px">
                           <asp:Label ID="ddlIdFIPD" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 77px">
                          <asp:Label ID="ddlIdSIPD" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 77px">
                            <asp:Label ID="ddlIdSEPD" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 77px">
                            <asp:Label ID="ddlIdEPD" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 77px">
                            <asp:Label ID="ddlIdNPD" runat="server"></asp:Label>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <br />
        <asp:GridView ID="GridView3" runat="server" Width="100%" EmptyDataText="None of the teachers are added to the Absentees List." HeaderStyle-BackColor="Black" HeaderStyle-ForeColor="White" AutoGenerateColumns="False" DataSourceID="SqlDataSource2" Caption='<table border="2" width="100%" cellpadding="0" cellspacing="0" bgcolor="darkblue"><tr class="auto-style11"><td>Arrangement Made</td></tr></table>' CaptionAlign="Top" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical">
            <AlternatingRowStyle BackColor="#DCDCDC" />
            <Columns>
                <asp:BoundField DataField="AbsentTeacherId" HeaderText="AbsentTeacherId" SortExpression="AbsentTeacherId" />
                <asp:BoundField DataField="ZPDTArrName" HeaderText="0" SortExpression="FPDTArrName" />
                <asp:BoundField DataField="FPDTArrName" HeaderText="1" SortExpression="FPDTArrName" />
                <asp:BoundField DataField="SPDTArrName" HeaderText="2" SortExpression="SPDTArrName" />
                <asp:BoundField DataField="TPDTArrName" HeaderText="3" SortExpression="TPDTArrName" />
                <asp:BoundField DataField="FOPDTArrName" HeaderText="4" SortExpression="FOPDTArrName" />
                <asp:BoundField DataField="FIPDTArrName" HeaderText="5" SortExpression="FIPDTArrName" />
                <asp:BoundField DataField="SIPDTArrName" HeaderText="6" SortExpression="SIPDTArrName" />
                <asp:BoundField DataField="SEPDTArrName" HeaderText="7" SortExpression="SEPDTArrName" />
                <asp:BoundField DataField="EPDTArrName" HeaderText="8" SortExpression="EPDTArrName" />
                <asp:BoundField DataField="NPDTArrName" HeaderText="9" SortExpression="NPDTArrName" />
            </Columns>
            <FooterStyle BackColor="#CCCCCC" ForeColor="Black" />
            <HeaderStyle BackColor="#000084" ForeColor="White" Font-Bold="True"></HeaderStyle>
            <PagerStyle BackColor="#999999" ForeColor="Black" HorizontalAlign="Center" />
