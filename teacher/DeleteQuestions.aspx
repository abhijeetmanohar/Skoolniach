<%@ Page Title="" Language="C#" MasterPageFile="~/teacher/TeacherMasterPage.master" AutoEventWireup="true" CodeFile="DeleteQuestions.aspx.cs" Inherits="teacher_DeleteParticipants" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table align="center" class="auto-style148">
        <tr>
            <td class="auto-style149" colspan="2"><strong>Delete Questions</strong></td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="auto-style151" colspan="2">
                ...
                <p>
                    <asp:Button ID="btnAQ" runat="server" Text="Delete Question From Authorized Quiz" OnClick="btnAQ_Click" />
                </p>
            </td>
        </tr>
        <tr>
