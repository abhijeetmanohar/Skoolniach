    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                /// lblDateArr.Text = DateTime.Now.Date.ToShortDateString();
...
try
    ...
    private void ZPD()
    {
        ...
        try
        {
            ...
            {
                ddlIdZPD.Text = "";
                ddlIdZPD.Text += question.Tables[0].Rows[0]["Id"].ToString();
            }
    ...
    private void FPD()
    {
        ...
        try
        {
            ...
            {
                ddlIdFPD.Text = "";
                ddlIdFPD.Text += question.Tables[0].Rows[0]["Id"].ToString();
            }
    ...
    private void SPD()
    {
        ...
        try
        {
            ...
            {
                ddlIdSPD.Text = "";
                ddlIdSPD.Text += question.Tables[0].Rows[0]["Id"].ToString();
            }
    ...
    private void TPD()
    {
        ...
        try
        {
            ...
            {
                ddlIdTPD.Text = "";
                ddlIdTPD.Text += question.Tables[0].Rows[0]["Id"].ToString();
            }
    ...
    private void FOPD()
    {
        ...
        try
        {
            ...
            {
                ddlIdFOPD.Text = "";
                ddlIdFOPD.Text += question.Tables[0].Rows[0]["Id"].ToString();
            }
    ...
    private void FIPD()
    {
        ...
        try
        {
            ...
            {
                ddlIdFIPD.Text = "";
                ddlIdFIPD.Text += question.Tables[0].Rows[0]["Id"].ToString();
            }
    ...
    private void SIPD()
    {
        ...
        try
        {
            ...
            {
                ddlIdSIPD.Text = "";
                ddlIdSIPD.Text += question.Tables[0].Rows[0]["Id"].ToString();
            }
    ...
    private void SEPD()
    {
        ...
        try
        {
            ...
            {
                ddlIdSEPD.Text = "";
                ddlIdSEPD.Text += question.Tables[0].Rows[0]["Id"].ToString();
            }
    ...
    private void EPD()
    {
        ...
        try
        {
            ...
            {
                ddlIdEPD.Text = "";
                ddlIdEPD.Text += question.Tables[0].Rows[0]["Id"].ToString();
            }
    ...
    private void NPD()
    {
        ...
        try
        {
            ...
            {
                ddlIdNPD.Text = "";
                ddlIdNPD.Text += question.Tables[0].Rows[0]["Id"].ToString();
            }
            if (lblSecondP.Text == "Free")
            {
